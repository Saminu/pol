...
var DefaultUIService = (function () {
        ...
        if (document && !config.disable) {
            ...
            this.maximizeMenuItem = this._createMenuItem(fullscreenIcon, 'Toggle Immersive View', function () {
                ...
                if (_this.viewService.viewportMode === 1 /* IMMERSIVE */) {
                    _this.viewService.desiredViewportMode = 0 /* EMBEDDED */;
                }
                else {
    ...
    DefaultUIService.prototype.updateMenu = function () {
        var _this = this;
        if (this.deviceService.isPresentingHMD && utils.isIOS) {
        ...
        if (utils.isIOS || utils.isAndroid)
            ...
            this._hideMenuItem(this.openInArgonMenuItem);
